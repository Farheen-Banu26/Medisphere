...
public class HealthTwinClient {
    ...
    public HealthTwinClient(@Value("${healthtwin.service.base-url:http://localhost:8083}") String baseUrl,
    ...
    private HealthTwinDTO fetchHealthTwin(String patientId) {
        try {
            ...
            logger.error("Failed to fetch health twin data: {}", ex.getMessage());
            return null;
        }
    }
}
