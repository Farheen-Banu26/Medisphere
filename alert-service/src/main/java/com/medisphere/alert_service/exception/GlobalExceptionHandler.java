...
import com.medisphere.alert_service.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(InvalidAcknowledgementException.class)
    public ResponseEntity<ErrorResponse> handleInvalidAcknowledgement(InvalidAcknowledgementException ex) {
        ErrorResponse error = new ErrorResponse(
